...
import (
	...
	"sentinelgo/config" // Application configuration management.
	"sentinelgo/tui"    // Terminal User Interface logic.
	"sentinelgo/utils"  // Utility functions, including the structured logger.
